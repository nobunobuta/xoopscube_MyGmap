<?php
    $tableDef['mygmap']['category'] = array(
        'fields' => array(
            ...
            'mygmap_category_updatetime' => array('int(10)',      'NOT NULL', "0", ''),
        ),
    ...
    $tableDef['mygmap']['area'] = array(
        'fields' => array(
            ...
            'mygmap_area_updatetime' => array('int(10)',      'NOT NULL', "0", ''),
        ),
    ...
    $tableDef['mygmap']['marker'] = array(
        'fields' => array(
            ...
            'mygmap_marker_uid'  =>        array('int(5) unsigned', 'NOT NULL', "0",  ''),
            'mygmap_marker_maptype' =>     array('int(5)',          'NOT NULL', "0",  ''),
            'mygmap_marker_updatetime' =>  array('int(10)',         'NOT NULL', "0",  ''),
        ),
