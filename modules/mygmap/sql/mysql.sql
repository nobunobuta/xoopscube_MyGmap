CREATE TABLE XXmygmapXX_category (
  ...
  mygmap_category_lat double(14,9) NOT NULL default 0.000000000,
  mygmap_category_lng double(14,9) NOT NULL default 0.000000000,
...
CREATE TABLE XXmygmapXX_area (
  ...
  mygmap_area_lat double(14,9) NOT NULL default 0.000000000,
  mygmap_area_lng double(14,9) NOT NULL default 0.000000000,
...
CREATE TABLE XXmygmapXX_marker (
  ...
  mygmap_marker_lat double(14,9) NOT NULL default 0.000000000,
  mygmap_marker_lng double(14,9) NOT NULL default 0.000000000,
