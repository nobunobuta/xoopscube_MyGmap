...
define("_MI_MYGMAP_INVGEO_DESC","<a href=\"http://wiki.knya.net/wiki.cgi?page=invgeocoder\">InvGeoCoder</a>を使用して、表示されている地図の中心位置の住所を表示します。<br /><br />地図の拡大率によって表示の詳細度が変化します。");
define("_MI_MYGMAP_LINK_MSG","現在地図表示用のURLを表示");
define("_MI_MYGMAP_LINK_DESC","");
define("_MI_MYGMAP_WIKI_MSG","現在地図表示用のWIKIタグを生成");
define("_MI_MYGMAP_WIKI_DESC","別途<a href=\"http://apap.co4.jp/modules/mydownloads/singlefile.php?cid=7&lid=51\">サイトパック</a>が必要です");
define("_MI_MYGMAP_BLOG_MSG","現在地図表示用のBlogタグを生成");
define("_MI_MYGMAP_BLOG_DESC","別途<a href=\"http://apap.co4.jp/modules/mydownloads/singlefile.php?cid=7&lid=51\">サイトパック</a>が必要です");
